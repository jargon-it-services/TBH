...
class DioClient {
  ...
  /// same exception mapping). Added for the Transaction Entry screen's
  /// `PUT /transactions/{id}` update call — the first feature needing a
  /// genuine PUT rather than overloading POST for updates.
  Future<Response> put(
    String path, {
    dynamic data,
  }) async {
