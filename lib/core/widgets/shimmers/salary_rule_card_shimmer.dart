...
/// Shimmer placeholder for one Salary Rule List card — same card shell
/// as [ServiceCardShimmer]/`ExpenseCardShimmer`.
class SalaryRuleCardShimmer extends StatelessWidget {
  const SalaryRuleCardShimmer({super.key});
