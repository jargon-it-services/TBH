...
/// Shimmer placeholder for one Staff List card — same card shell as
/// [ServiceCardShimmer]/`BranchCardShimmer`, laid out for a staff
/// member's own fields (name, designation/branch tags, employee code).
