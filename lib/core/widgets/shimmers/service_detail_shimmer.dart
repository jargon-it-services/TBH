...
/// Loading state for `ServiceDetailPage` — same skeleton shape
/// (header block + a stack of section boxes) as [BranchDetailShimmer].
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _box(width: 140, height: 18),
            const SizedBox(height: AppSpacing.verticalMedium),
            _box(height: 120, radius: AppRadius.large),
            const SizedBox(height: AppSpacing.verticalLarge),
            _box(height: 100, radius: AppRadius.large),
          ],
        ),
