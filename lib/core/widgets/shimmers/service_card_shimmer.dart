...
/// Shimmer placeholder for one Service List card — same card shell
/// (radius, border, shadow) as [BranchCardShimmer], laid out for a
/// service's own fields (name, category/gender tags, price) instead of
/// a branch's address.
